...
// @version      1.18
// @description  拦截舰C数据并推送到Supabase后端（建造资源消耗全栈版，修复高速建造事件丢失bug（dock_id兜底+FormData兼容））
// @author       Qing-Feng
...
(function() {
    ...
    if (window.self !== window.top) {
        ...
        console.log('[script_1.17] 在iframe中运行，不创建UI面板');
    }
    ...
    createPanel();
    addLog('<span style="color:#ffd700;">脚本已激活 script_1.17 @ ' + location.host + '，等待舰C请求...</span>');
