...
// @match        https://www.dmm.com/netgame/social/-/gadgets/*
...
(function() {
    ...
    if (window.self !== window.top) {
        ...
        console.log('[script107] 在iframe中运行，不创建UI面板');
    }
    ...
    win.XMLHttpRequest = FakeXHR;if (window.fetch) {
    ...
    createPanel();
    addLog('<span style="color:#ffd700;">脚本已激活 script107，等待舰C请求...</span>');
